...
with open(path_file_csv, "r", encoding="utf-8", errors='ignore') as vsvfile:
    ...
    for i in range(0, len(translations)):
        ...
        xml_string = etree.tostring(roots[i], encoding='unicode', method='xml', pretty_print=True,
